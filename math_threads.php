                            ...
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                    ...
                                    <div class="row g-3">
                                        <div class="row g-2"> 
                                            ...
                                            <form action="http://localhost/Post%20and%20Comments/View/FrontOfiice/deletepost.php?">
                                            <div class="col-6">
                                                <button class="btn btn-primary w-100 py-3" type="submit">deletepost</button>
                                                <br></br>
                                            </div>
                                            </form>
                                            <form action="http://localhost/Post%20and%20Comments/View/FrontOfiice/updatepost.php?">
                                            <div class="col-6">
                                                <button class="btn btn-primary w-100 py-3" type="submit">updatepost</button>
                                                <br></br>
                                            </div>
                                            </form>
...
foreach($list as $value){
    if($value['category']=="math"){
        $post_id=$value['id'];
?>
<div  onclick="location.assign('http://localhost/Post%20and%20Comments/View/FrontOfiice/thread.php?id=<?php echo $post_id; ?>')" class="container-xxl bg-white p-0">
