          ...
          <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div id="lessonCover" class="lesson-cover <?= !empty($lesson['image']) ? 'has-image' : '' ?>">
                  <?php if (!empty($lesson['image'])): ?>
                    ...
                    ?>
                    <img id="lessonCoverImg" class="lesson-cover-img" src="../../Front office/assets/uploads/lessons/<?= urlencode($imageName) ?>" alt="Lesson cover">
                    <div class="lesson-cover-overlay">
                      <div class="lesson-cover-action"><i class="fas fa-pencil-alt"></i></div>
                    </div>
                  <?php else: ?>
