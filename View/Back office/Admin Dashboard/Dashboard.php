...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Points -->
      <li class="nav-item">
        <a class="nav-link" href="points-dashboard.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="transactions-dashboard.php">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../Admin Moderation/View-profiles.html">View Profiles</a>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Recent activity overview</h6>
          ...
          <div class="row">
            ...
            <div class="tab-pane fade" id="points" role="tabpanel" aria-labelledby="points-tab">
              <?php
                ...
                $allUsers = $pointsController->getAll();
                $leaderboard = $pointsController->getLeaderboard(10);
              ?>
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            <?php foreach ($allUsers as $user): ?>
                              <tr><td><?php echo htmlspecialchars($user['starr_id']); ?></td><td><?php echo $user['total_points']; ?></td><td><?php echo $user['login_streak']; ?></td><td><?php echo date('M d, Y', strtotime($user['last_login_date'])); ?></td></tr>
                            <?php endforeach; ?>
                          </tbody>
                        </table>
                      </div>
