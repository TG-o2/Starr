...
// Get admin ID from session (use user_id set by login)
...
<div id="wrapper">
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active"><a class="nav-link"><span>Handle Report</span></a></li>
    <hr class="sidebar-divider">
    <div class="sidebar-heading">Work</div>
    <li class="nav-item"><a class="nav-link" href="../User/list_users.php"><i class="fas fa-fw fa-user"></i><span>View Profiles</span></a></li>
    <li class="nav-item"><a class="nav-link" href="Review-list.php"><i class="fa-solid fa-flag"></i><span>View Reports</span></a></li>
    <li class="nav-item"><a class="nav-link" href="../transactions.php"><i class="fas fa-coins"></i><span>Transactions</span></a></li>
    <li class="nav-item"><a class="nav-link" href="../Admin Dashboard/Dashboard.php"><i class="fas fa-fw fa-tachometer-alt"></i><span>Admin Dashboard</span></a></li>
