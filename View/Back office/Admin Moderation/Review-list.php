                                                ...
                                                <?php foreach ($reports as $r): ?>
                                                    ...
                                                    <div class="card shadow-sm mb-3 border-left-danger">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mt-3">  
                                                                <button class="btn btn-sm btn-success mr-2"  onclick="window.location.href='Update-report.php?id=<?= $r['reportId'] ?>'">
                                                                    <i class="fas fa-check mr-1"></i>Approve Report</button>
