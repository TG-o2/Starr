...
<body>
  <div class="container-xxl bg-white p-0">
   ...
   <!-- Navbar Start -->
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="../News/gestionnews.php" class="nav-item nav-link active">Articles</a>
                </div>
            </div>
        </nav>
        <!-- Navbar End -->
    ...
    <div class="container-fluid p-0 mb-5">
      <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
          <img class="img-fluid" src="../assets/img/carousel-1.jpg" alt="" style="width: 100%; height: 500px; object-fit: cover;">
          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .2);">
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-10 col-lg-8">
                  <h1 class="display-2 text-light animated slideInDown mb-4">Latest News & Updates</h1>
                  <p class="fs-5 fw-medium text-light mb-4 pb-2">Stay informed with the latest articles, events, and community updates from our school.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <main class="container">
      <?php
      // All PHP logic moved to top of file; display data only here
      ?>
                ...
                <article id="news-<?php echo (int)$news['newsid']; ?>" class="bg-white rounded p-5 shadow-sm mb-5 border-start border-4 border-primary">
                  <div class="mb-4">
                    <?php if (!empty($news['image'])): ?>
                      <img src="../uploads/news/<?php echo htmlspecialchars($news['image']); ?>" alt="<?php echo htmlspecialchars($news['title']); ?>" class="img-fluid rounded mb-4" style="width: 100%; max-height: 400px; object-fit: cover;">
                    <?php else: ?>
                  ...
                  <div class="mb-3">
                    ...
                    <p class="meta text-muted mb-0">
                      <i class="fas fa-calendar me-2"></i><?php $date = new DateTime($news['published_date']); echo $date->format('M j, Y'); ?>
                      <?php if (!empty($news['category'])): ?>
                        • <span class="badge bg-primary"><i class="fas fa-tag me-1"></i><?php echo htmlspecialchars(ucfirst($news['category'])); ?></span>
                      <?php endif; ?>
                    </p>
                  </div>
                  <div class="article-content mb-4 lh-lg">
  ...
  <script>
    // Track news views when comments are opened (proxy for engagement)
    document.addEventListener('click', function(e) {
      var btn = e.target.closest('.comments-preview');
      if (btn) {
        var id = btn.getAttribute('data-preview-for');
        if (id) {
          fetch('../../../api/track_view.php?type=news&id=' + encodeURIComponent(id)).catch(function(){});
        }
      }
    });
  </script>
    ...
    document.addEventListener('click', (e) => {
        ...
        if (closeBtn) {
            ...
            if (list) {
                ...
                const previewHeader = list.closest('.comments-container').querySelector('.comments-preview-header');
