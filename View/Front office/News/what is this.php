                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 rounded-bottom border-0 m-0">
                            <a href="../posts and comments/addpost.php" class="dropdown-item active">Create a post</a>
                    ...
                    <a href="gestionnews.php" class="nav-item nav-link">Articles</a>
                </div>
            </div>
        </nav>
        <!-- Navbar End -->
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="facility-item" style="background-color: #fbefdf;">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="facility-item" style="background-color: #fbefdf !important;">
