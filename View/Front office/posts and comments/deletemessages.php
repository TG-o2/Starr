...
<head>
    <meta charset="utf-8">
    <title>Delete Message | Starr</title>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="posts%20and%20comments/posts.html" class="nav-item nav-link">Posts</a>
                    <a href="classes.html" class="nav-item nav-link">Lessons</a>
                    ...
                    <a href="../point system/my-points.php" class="nav-item nav-link">LeaderBoard</a>
                    <a href="news.html" class="nav-item nav-link">Articles</a>
                </div>
