...
require_once __DIR__ . '/../../../Controller/BadgeHelper.php';
    ...
    // Using shared BadgeHelper for badge computation/rendering
...
<body>
    <div class="container-xxl bg-white p-0">
                            ...
                            <div class="row g-0">
                                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="h-100 d-flex flex-column justify-content-center p-5">
                                        <div class="row g-3">
                                            <div class="row g-2"> 
                                                <form action="addmessages.php" method="GET">
        ...
        <div class="container">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <div class="flex-shrink-0">
                            <?php 
                                $op_display_name = $value['username'] ?? ($value['fname'] . ' ' . $value['lname']);
                                $op_star_points = (int)($value['starPoints'] ?? 0);
                                $op_avatar = $value['avatar'] ?? 'default-avatar.png';
                            ?>
                            <img class="rounded-circle" 
                                 src="../assets/img/userProfile/<?php echo htmlspecialchars($op_avatar); ?>" 
                                 style="width: 60px; height: 60px; object-fit: cover;" 
                                 alt="<?php echo htmlspecialchars($op_display_name); ?>"
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="mb-1 d-flex align-items-center gap-2">
                                ...
                                <span class="text-warning ms-2" title="Star Points">
                                    <i class="fas fa-star"></i> <?php echo number_format($op_star_points); ?>
                                </span>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                ...
                                <div>
                                    <a href="../Reports/Make-report.html?type=post&id=<?php echo $post_id; ?>" class="btn btn-outline-danger btn-sm" title="Report this post">
            ...
            <!-- Messages/Replies -->
            <?php 
            $list_mes = $messagescontroller1->readmessagesWithUserInfo(); // Use new method with user info
            $hasMessages = false;
            $messageIndex = 0;
            ...
            <div class="card mb-3 message-item" id="message-<?php echo $value['id']; ?>">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-shrink-0">
                            <img class="rounded-circle" 
                                 src="../assets/img/userProfile/<?php echo htmlspecialchars($avatar); ?>" 
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="mb-2 d-flex align-items-center gap-2">
                                ...
                                <span class="text-warning ms-2" title="Star Points">
                                    <i class="fas fa-star"></i> <?php echo number_format((int)$star_points); ?>
                                </span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group">
                                        <!-- Update Button -->
                                        <a href="updatemessages.php?post_id=<?php echo $post_id ?>&id3=<?php echo $value['id']?>" 
                                        ...
                                        <a href="../Reports/Make-report.html?type=comment&id=<?php echo $value['id']; ?>" 
                                           class="btn btn-outline-danger" title="Report this message">
                                            <i class="fa-solid fa-flag"></i> Report
                                        </a>
                                        
                                        <!-- Report Message Author Button -->
                                        <a href="../Reports/Make-report.html?type=user&id=<?php echo (int)$value['user_id']; ?>" 
                                           class="btn btn-outline-danger" title="Report this user">
                                            <i class="fa-solid fa-user-flag"></i> Report User
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <a href="addmessages.php?post_id=<?php echo $post_id ?>" 
