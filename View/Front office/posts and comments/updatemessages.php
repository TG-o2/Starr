<?php
    ...
    if (!isset($_SESSION['user_id'])) {
        die('You must be logged in to update a message.');
    }
    $current_user = $_SESSION['username'] ?? 'Guest';
    $current_user_id = $_SESSION['user_id']; // Use user_id from session
    
    if(isset($_POST['postid'])){
        // Create message with user_id instead of username
        $messages1=new messages($_POST['postid'],$_GET['post_id'],$_POST['content'],0,$current_user_id,0,date('Y-m-d H:i:s'));
        $messagescontroller1=new messagescontroller();
        $messagescontroller1->updatemessages($messages1,$_POST['postid']);
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="utf-8">
    <title>Edit Message | Starr</title>
...
<body>
                    ...
                    <div class="row g-0">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input name="postid" type="hidden" class="form-control border-0" id="mesid" placeholder="bkbkb" value="<?php echo $_GET['id3']?>">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded" src="/Front office/assets/img/appointment.jpg" style="object-fit: cover;">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="inputmessages.js"></script>
