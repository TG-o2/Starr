...
document.getElementById("subject").addEventListener("keyup",(e)=>{
    e.preventDefault();
    var input_title=document.getElementById("subject");
    const REG=/^[A-Za-z]{3,}$/;
    if(REG.test(input_title.value)==false){
        document.getElementById("errMes2").textContent="at least 3 characters"
        document.getElementById("errMes2").style.color="red"
    }else {document.getElementById("errMes2").textContent="success"
        document.getElementById("errMes2").style.color="green"
    }
})
document.getElementById("content").addEventListener("keyup",(e)=>{
    ...
    if(REG.test(input_title.value)==false){
        ...
        document.getElementById("errMes3").textContent="success"
