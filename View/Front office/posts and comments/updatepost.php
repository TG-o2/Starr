<?php
    ...
    if(isset($_POST['postid'])){
        ...
        $post1=new post($_POST['postid'],$_POST['subject'],$_POST['content'],0,$current_user_id,$_POST['category'],0,0,date('Y-m-d H:i:s'));
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input name="postid" type="hidden" class="form-control border-0"
                                            id="postid"
                                            value="<?php echo isset($_GET['id2']) ? $_GET['id2'] : ''; ?>">
