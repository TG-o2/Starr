<?php
    ...
    if (!isset($_SESSION['user_id'])) {
        die('You must be logged in to add a message.');
    }
    ...
    if(isset($_POST['content'])){
        if(strlen($_POST['content'])>=3){
            ...
            $messages1=new messages(NULL,$post_id,$_POST['content'],0,$current_user_id,0,date('Y-m-d H:i:s'));
