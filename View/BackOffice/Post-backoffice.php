                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Todays comments</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">3,544</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Post ID" style="margin-bottom: 30px;">
                                    </div>
                                    <br></br>
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Comment on the post" style="margin-bottom: 30px;">
                                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Comment ID" style="margin-bottom: 30px;">
                                    </div>
                                    <br></br>
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#" class="btn btn-success btn-icon-split" style="width:167px;">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-check"></i>
                                        </span>
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    ...
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Comment" style="margin-bottom: 30px;">
                                    </div>
                                </div>
                            </div>
                            <?php
    ...
    <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <p>number_messages: <?php echo $value['number_messages']; ?> </p>
                                        <p>view_count: <?php echo $value['view_count']; ?> </p>
                                        <p>like_count: <?php echo $value['like_count']; ?> </p>
                                        <p>user_name: <?php echo $value['user_name']; ?> </p>
                                        <p>category: <?php echo $value['category']; ?> </p>
                                        <p>created_at: <?php echo $value['created_at']; ?> </p>
                                    </div>
                                    <br></br>
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
...
<div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <p>id: <?php echo $value['id']; ?> </p>
                                        <p>post_id: <?php echo $value['post_id']; ?> </p>
                                        <p>content: <?php echo $value['content']; ?> </p>
                                        <p>number_replies: <?php echo $value['number_replies']; ?> </p>
                                        <p>like_count: <?php echo $value['like_count']; ?> </p>
                                        <p>user_name: <?php echo $value['user_name']; ?> </p>
                                        <p>created_at: <?php echo $value['created_at']; ?> </p>
                                    </div>
