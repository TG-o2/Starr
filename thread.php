                            ...
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                    ...
                                    <div class="row g-3">
                                        <div class="row g-2"> 
                                            ...
                                            <div class="col-6">
                                                <button class="btn btn-primary w-100 py-3" type="submit">add message</button>
                                                <br></br>
                                            </div>
                                            </form>
                                            <form action="http://localhost/Post%20and%20Comments/View/FrontOfiice/deletemessages.php?">
                                            <div class="col-6">
                                                <button class="btn btn-primary w-100 py-3" type="submit">delete message</button>
                                                <br></br>
                                            </div>
                                            </form>
                                            <form action="http://localhost/Post%20and%20Comments/View/FrontOfiice/updatemessages.php?">
                                                <input type="hidden" name="post_id" value="<?php echo $_GET['id']?>">
                                            <div class="col-6">
                                                <button class="btn btn-primary w-100 py-3" type="submit">update message</button>
                                                <br></br>
                                            </div>
                                            </form>
...
?>
<div class="container-xxl bg-white p-0">
<div style="background-color: blue; padding: 20px; border-radius: 20px;">
    <div class="testimonial-item bg-light rounded p-5">
        <p class="fs-5"><?php echo $value['subject']; ?></p>
        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-3.jpg" style="width: 90px; height: 90px;">
            <div class="ps-3">
                <h3 class="mb-1">kids name</h3>
...
foreach($list_mes as $value){
    if($value['post_id']==$_GET['id']){
?>
<div class="container-xxl bg-white p-0">
<div style="background-color: blue; padding: 20px; border-radius: 20px;">
    <div class="testimonial-item bg-light rounded p-5">
        <p class="fs-5"><?php echo $value['content']; ?></p>
        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-3.jpg" style="width: 90px; height: 90px;">
            <div class="ps-3">
                <h3 class="mb-1">kids name</h3>
            ...
            <i class="fa-solid fa-heart fa-3x" style="color: #FFD43B; cursor: pointer;" 
   onclick="toggleLike(this)" id="likeButton"></i>
