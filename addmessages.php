<?php
    ...
    $messages1=new messages($_POST['id'],$_GET['post_id'],$_POST['content'],0,"iheb",222,"2024-01-15 10:30:00");
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input id="mesid" name="id" type="number" class="form-control border-0" placeholder="bkbkb">
                                                <label for="mesid">id</label>
                                                <p id="errMes4"></p>
                                            </div>
                                        </div>
