    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-white rounded shadow p-4 p-md-5">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="lessonList_direct.php" class="btn btn-outline-primary btn-sm">Back</a>
                        </div>
                ...
                <form method="POST" class="row g-3" id="lessonForm" enctype="multipart/form-data">
                    <div class="col-12">
                        <style>
                        ...
                        <div id="lessonCover" class="lesson-cover <?= !empty($lesson['thumbnail_url']) ? 'has-image' : '' ?>">
                            <?php if (!empty($lesson['thumbnail_url'])): ?>
                                <img id="lessonCoverImg" class="lesson-cover-img" src="/lessons_project<?= htmlspecialchars($lesson['thumbnail_url']) ?>" alt="Lesson cover">
                                <div class="lesson-cover-overlay">
                                    <div class="lesson-cover-action" aria-hidden="true"><i class="bi bi-pencil"></i></div>
                                </div>
                            <?php else: ?>
                    ...
                    <div class="col-12">
                        ...
                        <input type="hidden" name="ageRange" id="age-range-value" value="<?= htmlspecialchars($lesson['ageRange'] ?? '5-18') ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="quiz_time_limit" name="quiz_time_limit" min="1" max="180" placeholder="e.g., 30" value="<?= htmlspecialchars($lesson['quiz_time_limit'] ?? 30) ?>">
                    ...
                    <div class="col-12 d-flex gap-2 pt-2">
                        ...
                        <a href="lessonList_direct.php" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </form>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (thumbnailInput && cover) {
            ...
            thumbnailInput.addEventListener('change', function() {
                ...
                const img = document.getElementById('lessonCoverImg');
                ...
                if (img) {
                    ...
                    newImg.id = 'lessonCoverImg';
                    newImg.className = 'lesson-cover-img';
                    newImg.alt = 'Lesson cover';
                    newImg.src = url;
                    cover.prepend(newImg);
