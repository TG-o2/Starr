                        ...
                        <?php if (!empty($lessons)): ?>
                            <?php foreach ($lessons as $lesson): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars((string)($lesson['average_age'] ?? '')); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="/lessons_project/views/back/questionForm_direct.php?lessonId=<?php echo $lesson['lessonId']; ?>" class="btn btn-warning btn-sm" title="Quiz">
