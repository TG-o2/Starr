        ...
        <?php if (!empty($lessons)): ?>
            <div class="lessons-grid">
                <?php foreach ($lessons as $lesson): ?>
                    <?php
                        // Get the attempt for this specific lesson
                        $attempt = $quizAttemptModel->getAttempt($lesson['lessonId'], $studentId);
                    ?>
                    <div class="lesson-card">
                        <?php if ($attempt): ?>
                            <div class="quiz-score" style="background: <?= ($attempt['score'] / $attempt['totalQuestions'] >= 0.5) ? 'var(--success)' : 'var(--danger)' ?>">
                        ...
                        <div class="lesson-info">
                            ...
                            <div class="lesson-actions">
                                ...
                                <a href="/lessons_project/views/front/lessonQuiz_direct.php?lessonId=<?php echo htmlspecialchars($lesson['lessonId']); ?>" class="btn-lesson btn-quiz">
                                    <i class="fas fa-play-circle"></i> Quiz
                                </a>
                            </div>
                        </div>
                    </div>
